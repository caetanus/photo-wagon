...
Rectangle {
    ...
    /// parsed library.moments.moments: [{key, title, subtitle, cover, count}]
    ...
    Flickable {
        ...
        Column {
            ...
            Row { key: "moments"; title: "Moments"; icon: icons.moments; detail: sidebar.moments.length ? String(sidebar.moments.length) : "" }
            Row {
