...
// ImageStats + statsOf live in a pure module (no libvips) so the phone can use them;
// `imageStats(source)` below is the libvips decode path that feeds statsOf.
public import photowagon.core.thumbs.imagestats : ImageStats, statsOf;
...
// statsOf now lives in photowagon.core.thumbs.imagestats (re-exported above).
